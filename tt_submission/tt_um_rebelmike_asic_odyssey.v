module tt_um_rebelmike_asic_odyssey (clk,
 ...
 sky130_fd_sc_hd__diode_2 ANTENNA_1 (.DIODE(_037_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__diode_2 ANTENNA_2 (.DIODE(\timing.count[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__diode_2 ANTENNA_3 (.DIODE(\timing.count[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__diode_2 ANTENNA_4 (.DIODE(_016_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__diode_2 ANTENNA_5 (.DIODE(_018_),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__diode_2 ANTENNA_6 (.DIODE(\timing.count[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_fd_sc_hd__fill_1 FILLER_14_70 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__fill_1 FILLER_15_1 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__fill_1 FILLER_15_110 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_fd_sc_hd__fill_1 FILLER_2_342 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__fill_1 FILLER_3_1 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_fd_sc_hd__fill_1 FILLER_4_95 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__fill_1 FILLER_5_1 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_fd_sc_hd__fill_1 FILLER_5_83 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__fill_1 FILLER_6_1 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_fd_sc_hd__fill_1 FILLER_7_342 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__fill_2 FILLER_8_1 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_fd_sc_hd__inv_2 _405_ (.A(\i_music.sample[0] ),
    ...
    .VPWR(VPWR),
    .Y(_013_));
 sky130_fd_sc_hd__inv_2 _406_ (.A(net14),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_075_));
 sky130_fd_sc_hd__inv_2 _407_ (.A(\i_music.thresh[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_076_));
 sky130_fd_sc_hd__inv_2 _408_ (.A(\i_music.thresh[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_077_));
 sky130_fd_sc_hd__inv_2 _409_ (.A(\i_music.thresh[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__inv_2 _410_ (.A(\i_music.thresh[9] ),
    ...
    .VPWR(VPWR),
    .Y(_079_));
 sky130_fd_sc_hd__inv_2 _411_ (.A(net22),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_080_));
 sky130_fd_sc_hd__inv_2 _412_ (.A(net28),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_081_));
 sky130_fd_sc_hd__inv_2 _413_ (.A(\timing.count[9] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_082_));
 sky130_fd_sc_hd__inv_2 _414_ (.A(net29),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_083_));
 sky130_fd_sc_hd__inv_2 _415_ (.A(net51),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_084_));
 sky130_fd_sc_hd__inv_2 _416_ (.A(\cell_state[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_085_));
 sky130_fd_sc_hd__inv_2 _417_ (.A(net10),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__inv_2 _418_ (.A(net9),
    ...
    .VPWR(VPWR),
    .Y(_087_));
 sky130_fd_sc_hd__inv_2 _419_ (.A(net5),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__or3_2 _420_ (.A(\timing.count[10] ),
    ...
    .VPWR(VPWR),
    .X(_089_));
 sky130_fd_sc_hd__o21ai_2 _421_ (.A1(net16),
    .A2(\counter_r[0] ),
    .B1(\timing.count[10] ),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__xnor2_2 _437_ (.A(\i_music.sample[7] ),
    ...
    .VPWR(VPWR),
    .Y(_020_));
 sky130_fd_sc_hd__o21a_2 _438_ (.A1(net16),
    .A2(\counter_r[1] ),
    .B1(\timing.count[11] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_099_));
 sky130_fd_sc_hd__or3_2 _439_ (.A(net16),
    .B(\counter_r[1] ),
    .C(\timing.count[11] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_100_));
 sky130_fd_sc_hd__and2b_2 _440_ (.A_N(_099_),
    .B(_100_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_101_));
 sky130_fd_sc_hd__xor2_2 _441_ (.A(_089_),
    .B(_101_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(\adj_y[1] ));
 sky130_fd_sc_hd__a21o_2 _442_ (.A1(_089_),
    .A2(_100_),
    .B1(_099_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_102_));
 sky130_fd_sc_hd__o21ai_2 _443_ (.A1(net16),
    .A2(\counter_r[2] ),
    .B1(\timing.count[12] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_103_));
 sky130_fd_sc_hd__inv_2 _444_ (.A(_103_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_104_));
 sky130_fd_sc_hd__or3_2 _445_ (.A(net17),
    .B(\counter_r[2] ),
    .C(\timing.count[12] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_105_));
 sky130_fd_sc_hd__and2_2 _446_ (.A(_103_),
    .B(_105_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_106_));
 sky130_fd_sc_hd__xor2_2 _447_ (.A(_102_),
    .B(_106_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(\adj_y[2] ));
 sky130_fd_sc_hd__a21o_2 _448_ (.A1(_102_),
    .A2(_106_),
    .B1(_104_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_107_));
 sky130_fd_sc_hd__o21a_2 _449_ (.A1(net16),
    .A2(\counter_r[3] ),
    .B1(\timing.count[13] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_108_));
 sky130_fd_sc_hd__or3_2 _450_ (.A(net16),
    .B(\counter_r[3] ),
    .C(\timing.count[13] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_109_));
 sky130_fd_sc_hd__nand2b_2 _451_ (.A_N(_108_),
    .B(_109_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_110_));
 sky130_fd_sc_hd__xnor2_2 _452_ (.A(_107_),
    .B(_110_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(\adj_y[3] ));
 sky130_fd_sc_hd__o21a_2 _453_ (.A1(net16),
    .A2(\counter_r[4] ),
    .B1(\timing.count[14] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_111_));
 sky130_fd_sc_hd__nor3_2 _454_ (.A(net16),
    .B(\counter_r[4] ),
    .C(\timing.count[14] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_112_));
 sky130_fd_sc_hd__nor2_2 _455_ (.A(_111_),
    .B(_112_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_113_));
 sky130_fd_sc_hd__a211o_2 _456_ (.A1(_102_),
    .A2(_106_),
    .B1(_108_),
    .C1(_104_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_114_));
 sky130_fd_sc_hd__nand2_2 _457_ (.A(_109_),
    .B(_114_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_115_));
 sky130_fd_sc_hd__xnor2_2 _458_ (.A(_113_),
    .B(_115_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(\adj_y[4] ));
 sky130_fd_sc_hd__nor2_2 _459_ (.A(net15),
    .B(\counter_r[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_116_));
 sky130_fd_sc_hd__o21a_2 _460_ (.A1(net15),
    .A2(\counter_r[5] ),
    .B1(net44),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_117_));
 sky130_fd_sc_hd__xnor2_2 _461_ (.A(net44),
    .B(_116_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_118_));
 sky130_fd_sc_hd__a31o_2 _462_ (.A1(_109_),
    .A2(_113_),
    .A3(_114_),
    .B1(_111_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_119_));
 sky130_fd_sc_hd__xor2_2 _463_ (.A(_118_),
    .B(_119_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(\adj_y[5] ));
 sky130_fd_sc_hd__nand2_2 _464_ (.A(net41),
    .B(net35),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_120_));
 sky130_fd_sc_hd__or4bb_2 _465_ (.A(net44),
    .B(_120_),
    .C_N(\timing.count[13] ),
    .D_N(\timing.count[14] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_121_));
 sky130_fd_sc_hd__a211o_2 _466_ (.A1(net44),
    .A2(net41),
    .B1(net38),
    .C1(net40),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_122_));
 sky130_fd_sc_hd__nor2_2 _467_ (.A(net22),
    .B(net24),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_123_));
 sky130_fd_sc_hd__nand2_2 _468_ (.A(_081_),
    .B(_123_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_124_));
 sky130_fd_sc_hd__a32o_2 _469_ (.A1(net18),
    .A2(\timing.count[9] ),
    .A3(_124_),
    .B1(_122_),
    .B2(net35),
    ...
    .VPWR(VPWR),
    .X(_125_));
 sky130_fd_sc_hd__and2b_2 _470_ (.A_N(_125_),
    .B(_121_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(\timing.active ));
 sky130_fd_sc_hd__and2_2 _471_ (.A(_080_),
    .B(net24),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_126_));
 sky130_fd_sc_hd__nor2_2 _472_ (.A(_080_),
    .B(net25),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_127_));
 sky130_fd_sc_hd__a31o_2 _473_ (.A1(_081_),
    .A2(_083_),
    .A3(_127_),
    .B1(_126_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_128_));
 sky130_fd_sc_hd__nand3_2 _474_ (.A(net21),
    .B(\timing.count[9] ),
    .C(_128_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(hsync));
 sky130_fd_sc_hd__nand3b_2 _475_ (.A_N(\adj_y[0] ),
    .B(_101_),
    .C(_106_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_129_));
 sky130_fd_sc_hd__nor3b_2 _476_ (.A(hsync_r),
    .B(_129_),
    .C_N(hsync),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_000_));
 sky130_fd_sc_hd__and3_2 _477_ (.A(\timing.count[10] ),
    .B(\timing.count[11] ),
    .C(\timing.count[12] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_130_));
 sky130_fd_sc_hd__a21oi_2 _478_ (.A1(\timing.count[10] ),
    .A2(\timing.count[11] ),
    .B1(\timing.count[12] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_131_));
 sky130_fd_sc_hd__nor3_2 _479_ (.A(_121_),
    .B(_130_),
    .C(_131_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(\timing.vsync ));
 sky130_fd_sc_hd__and2b_2 _480_ (.A_N(vsync_r),
    .B(\timing.vsync ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_001_));
 sky130_fd_sc_hd__xor2_2 _481_ (.A(\i_music.thresh[6] ),
    .B(net26),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_132_));
 sky130_fd_sc_hd__a221o_2 _482_ (.A1(\i_music.thresh[5] ),
    .A2(_081_),
    .B1(\timing.count[9] ),
    .B2(_079_),
    .C1(_132_),
    ...
    .VPWR(VPWR),
    .X(_133_));
 sky130_fd_sc_hd__xnor2_2 _483_ (.A(\i_music.thresh[4] ),
    .B(net29),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_134_));
 sky130_fd_sc_hd__o221ai_2 _484_ (.A1(\i_music.thresh[7] ),
    .A2(_080_),
    .B1(_081_),
    .B2(\i_music.thresh[5] ),
    .C1(_134_),
    ...
    .VPWR(VPWR),
    .Y(_135_));
 sky130_fd_sc_hd__xor2_2 _485_ (.A(ui_in[7]),
    .B(\counter_r[9] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_136_));
 sky130_fd_sc_hd__xnor2_2 _486_ (.A(ui_in[7]),
    .B(\counter_r[9] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_137_));
 sky130_fd_sc_hd__nand2_2 _487_ (.A(_075_),
    .B(_137_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_138_));
 sky130_fd_sc_hd__xor2_2 _488_ (.A(\i_music.thresh[3] ),
    .B(\timing.count[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_139_));
 sky130_fd_sc_hd__a221o_2 _489_ (.A1(\i_music.thresh[7] ),
    .A2(_080_),
    .B1(_082_),
    .B2(\i_music.thresh[9] ),
    .C1(_139_),
    ...
    .VPWR(VPWR),
    .X(_140_));
 sky130_fd_sc_hd__or4b_2 _490_ (.A(_133_),
    .B(_135_),
    .C(_140_),
    .D_N(_138_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_141_));
 sky130_fd_sc_hd__xor2_2 _491_ (.A(ui_in[6]),
    .B(\counter_r[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_142_));
 sky130_fd_sc_hd__xnor2_2 _492_ (.A(ui_in[6]),
    .B(\counter_r[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_143_));
 sky130_fd_sc_hd__xor2_2 _493_ (.A(ui_in[4]),
    .B(\counter_r[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_144_));
 sky130_fd_sc_hd__xor2_2 _494_ (.A(ui_in[5]),
    .B(\counter_r[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_145_));
 sky130_fd_sc_hd__xnor2_2 _495_ (.A(ui_in[5]),
    .B(\counter_r[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_146_));
 sky130_fd_sc_hd__and4_2 _496_ (.A(_136_),
    .B(_142_),
    .C(_144_),
    .D(net13),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_147_));
 sky130_fd_sc_hd__or2_2 _497_ (.A(\i_music.thresh[2] ),
    .B(net33),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_148_));
 sky130_fd_sc_hd__nand2_2 _498_ (.A(\i_music.thresh[2] ),
    .B(net33),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_149_));
 sky130_fd_sc_hd__or2_2 _499_ (.A(\i_music.thresh[1] ),
    .B(net34),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_150_));
 sky130_fd_sc_hd__nand2_2 _500_ (.A(\i_music.thresh[1] ),
    .B(net34),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_151_));
 sky130_fd_sc_hd__a22o_2 _501_ (.A1(_148_),
    .A2(_149_),
    .B1(_150_),
    .B2(_151_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_152_));
 sky130_fd_sc_hd__or2_2 _502_ (.A(\i_music.thresh[0] ),
    .B(net47),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_153_));
 sky130_fd_sc_hd__nand2_2 _503_ (.A(\i_music.thresh[0] ),
    .B(net47),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_154_));
 sky130_fd_sc_hd__nand2_2 _504_ (.A(\i_music.thresh[8] ),
    .B(net18),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_155_));
 sky130_fd_sc_hd__or2_2 _505_ (.A(\i_music.thresh[8] ),
    .B(net18),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_156_));
 sky130_fd_sc_hd__a22o_2 _506_ (.A1(_153_),
    .A2(_154_),
    .B1(_155_),
    .B2(_156_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_157_));
 sky130_fd_sc_hd__nor4_2 _507_ (.A(_141_),
    .B(_147_),
    .C(_152_),
    .D(_157_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(\i_music.wen ));
 sky130_fd_sc_hd__xor2_2 _508_ (.A(net35),
    .B(_138_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_158_));
 sky130_fd_sc_hd__nor2_2 _509_ (.A(net14),
    .B(_142_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_159_));
 sky130_fd_sc_hd__o21ai_2 _510_ (.A1(net14),
    .A2(_142_),
    .B1(net38),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_160_));
 sky130_fd_sc_hd__or3_2 _511_ (.A(net14),
    .B(net38),
    .C(_142_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_161_));
 sky130_fd_sc_hd__and2_2 _512_ (.A(_160_),
    .B(_161_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_162_));
 sky130_fd_sc_hd__and2_2 _513_ (.A(_158_),
    .B(_162_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_163_));
 sky130_fd_sc_hd__nor2_2 _514_ (.A(net15),
    .B(net13),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_164_));
 sky130_fd_sc_hd__or3_2 _515_ (.A(net14),
    .B(net40),
    .C(net13),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_165_));
 sky130_fd_sc_hd__or2_2 _516_ (.A(net15),
    .B(_144_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_166_));
 sky130_fd_sc_hd__nand2_2 _517_ (.A(net41),
    .B(_166_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_167_));
 sky130_fd_sc_hd__or2_2 _518_ (.A(net41),
    .B(_166_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_168_));
 sky130_fd_sc_hd__and2_2 _519_ (.A(_167_),
    .B(_168_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_169_));
 sky130_fd_sc_hd__a21o_2 _520_ (.A1(_118_),
    .A2(_119_),
    .B1(_117_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_170_));
 sky130_fd_sc_hd__nand2_2 _521_ (.A(_169_),
    .B(_170_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_171_));
 sky130_fd_sc_hd__o21ai_2 _522_ (.A1(net14),
    .A2(net13),
    .B1(net40),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_172_));
 sky130_fd_sc_hd__nand2_2 _523_ (.A(_167_),
    .B(_172_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_173_));
 sky130_fd_sc_hd__a21o_2 _524_ (.A1(_169_),
    .A2(_170_),
    .B1(_173_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_174_));
 sky130_fd_sc_hd__nand3_2 _525_ (.A(_163_),
    .B(_165_),
    .C(_174_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_175_));
 sky130_fd_sc_hd__and3b_2 _526_ (.A_N(_159_),
    .B(_158_),
    .C(net38),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_176_));
 sky130_fd_sc_hd__a21oi_2 _527_ (.A1(net35),
    .A2(_138_),
    .B1(_176_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_177_));
 sky130_fd_sc_hd__nand2_2 _528_ (.A(_175_),
    .B(_177_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_178_));
 sky130_fd_sc_hd__and2_2 _529_ (.A(_165_),
    .B(_172_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_179_));
 sky130_fd_sc_hd__and4_2 _530_ (.A(_113_),
    .B(_118_),
    .C(_169_),
    .D(_179_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_180_));
 sky130_fd_sc_hd__nor2_2 _531_ (.A(_110_),
    .B(_129_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_181_));
 sky130_fd_sc_hd__a31oi_2 _532_ (.A1(_163_),
    .A2(_180_),
    .A3(_181_),
    .B1(_084_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_182_));
 sky130_fd_sc_hd__and2_2 _533_ (.A(_178_),
    .B(_182_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(cell_rst_n));
 sky130_fd_sc_hd__and2_2 _534_ (.A(\counter_r[0] ),
    .B(\counter_r[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_183_));
 sky130_fd_sc_hd__and3_2 _535_ (.A(\counter_r[0] ),
    .B(\counter_r[1] ),
    .C(\counter_r[2] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_184_));
 sky130_fd_sc_hd__and2_2 _536_ (.A(\counter_r[3] ),
    .B(_184_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_185_));
 sky130_fd_sc_hd__and3_2 _537_ (.A(\counter_r[4] ),
    .B(\counter_r[5] ),
    .C(_185_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_186_));
 sky130_fd_sc_hd__and2_2 _538_ (.A(\counter_r[6] ),
    .B(_186_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_187_));
 sky130_fd_sc_hd__nand2_2 _539_ (.A(\counter_r[7] ),
    .B(_187_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_188_));
 sky130_fd_sc_hd__and3_2 _540_ (.A(\counter_r[8] ),
    .B(\counter_r[7] ),
    .C(_187_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_189_));
 sky130_fd_sc_hd__and2_2 _541_ (.A(\counter_r[9] ),
    .B(_189_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_190_));
 sky130_fd_sc_hd__nand2_2 _542_ (.A(net15),
    .B(_190_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_191_));
 sky130_fd_sc_hd__nand2_2 _543_ (.A(\counter_r[0] ),
    .B(_191_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_002_));
 sky130_fd_sc_hd__nor2_2 _544_ (.A(\counter_r[0] ),
    .B(\counter_r[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_192_));
 sky130_fd_sc_hd__o21ai_2 _545_ (.A1(_183_),
    .A2(_192_),
    .B1(_191_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_004_));
 sky130_fd_sc_hd__nor2_2 _546_ (.A(\counter_r[2] ),
    .B(_183_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_193_));
 sky130_fd_sc_hd__o21ai_2 _547_ (.A1(_184_),
    .A2(_193_),
    .B1(_191_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_005_));
 sky130_fd_sc_hd__nor2_2 _548_ (.A(\counter_r[3] ),
    .B(_184_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_194_));
 sky130_fd_sc_hd__nor2_2 _549_ (.A(_185_),
    .B(_194_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_006_));
 sky130_fd_sc_hd__xor2_2 _550_ (.A(\counter_r[4] ),
    .B(_185_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_007_));
 sky130_fd_sc_hd__a21oi_2 _551_ (.A1(\counter_r[4] ),
    .A2(_185_),
    .B1(\counter_r[5] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_195_));
 sky130_fd_sc_hd__o21ai_2 _552_ (.A1(_186_),
    .A2(_195_),
    .B1(_191_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_008_));
 sky130_fd_sc_hd__xor2_2 _553_ (.A(\counter_r[6] ),
    .B(_186_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_009_));
 sky130_fd_sc_hd__or2_2 _554_ (.A(\counter_r[7] ),
    .B(_187_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_196_));
 sky130_fd_sc_hd__a22o_2 _555_ (.A1(net16),
    .A2(_190_),
    .B1(_196_),
    .B2(_188_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_010_));
 sky130_fd_sc_hd__a21oi_2 _556_ (.A1(\counter_r[7] ),
    .A2(_187_),
    .B1(\counter_r[8] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_197_));
 sky130_fd_sc_hd__o21ai_2 _557_ (.A1(_189_),
    .A2(_197_),
    .B1(_191_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_011_));
 sky130_fd_sc_hd__nor2_2 _558_ (.A(\counter_r[9] ),
    .B(_189_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_198_));
 sky130_fd_sc_hd__nor2_2 _559_ (.A(_190_),
    .B(_198_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_012_));
 sky130_fd_sc_hd__or2_2 _560_ (.A(net15),
    .B(_190_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_199_));
 sky130_fd_sc_hd__and2_2 _561_ (.A(_191_),
    .B(_199_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_003_));
 sky130_fd_sc_hd__nor2_2 _562_ (.A(\cell_state[14] ),
    .B(\cell_state[13] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_200_));
 sky130_fd_sc_hd__xnor2_2 _563_ (.A(\cell_state[15] ),
    .B(_200_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_072_));
 sky130_fd_sc_hd__nor2_2 _564_ (.A(\cell_state[12] ),
    .B(\cell_state[13] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_201_));
 sky130_fd_sc_hd__xnor2_2 _565_ (.A(\cell_state[14] ),
    .B(_201_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_071_));
 sky130_fd_sc_hd__nor2_2 _566_ (.A(\cell_state[11] ),
    .B(\cell_state[12] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_202_));
 sky130_fd_sc_hd__xnor2_2 _567_ (.A(\cell_state[13] ),
    .B(_202_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_070_));
 sky130_fd_sc_hd__nor2_2 _568_ (.A(\cell_state[10] ),
    .B(\cell_state[11] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_203_));
 sky130_fd_sc_hd__xnor2_2 _569_ (.A(\cell_state[12] ),
    .B(_203_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_069_));
 sky130_fd_sc_hd__nor2_2 _570_ (.A(\cell_state[10] ),
    .B(\cell_state[9] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_204_));
 sky130_fd_sc_hd__xnor2_2 _571_ (.A(\cell_state[11] ),
    .B(_204_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_068_));
 sky130_fd_sc_hd__nor2_2 _572_ (.A(\cell_state[8] ),
    .B(\cell_state[9] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_205_));
 sky130_fd_sc_hd__xnor2_2 _573_ (.A(\cell_state[10] ),
    .B(_205_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_067_));
 sky130_fd_sc_hd__nor2_2 _574_ (.A(\cell_state[7] ),
    .B(\cell_state[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_206_));
 sky130_fd_sc_hd__xnor2_2 _575_ (.A(\cell_state[9] ),
    .B(_206_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_066_));
 sky130_fd_sc_hd__nor2_2 _576_ (.A(\cell_state[6] ),
    .B(\cell_state[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_207_));
 sky130_fd_sc_hd__xnor2_2 _577_ (.A(\cell_state[8] ),
    .B(_207_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_065_));
 sky130_fd_sc_hd__nor2_2 _578_ (.A(\cell_state[6] ),
    .B(\cell_state[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_208_));
 sky130_fd_sc_hd__xnor2_2 _579_ (.A(\cell_state[7] ),
    .B(_208_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_064_));
 sky130_fd_sc_hd__nor2_2 _580_ (.A(\cell_state[4] ),
    .B(\cell_state[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_209_));
 sky130_fd_sc_hd__xnor2_2 _581_ (.A(\cell_state[6] ),
    .B(_209_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_063_));
 sky130_fd_sc_hd__nor2_2 _582_ (.A(\cell_state[3] ),
    .B(\cell_state[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_210_));
 sky130_fd_sc_hd__xnor2_2 _583_ (.A(\cell_state[5] ),
    .B(_210_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_062_));
 sky130_fd_sc_hd__nor2_2 _584_ (.A(\cell_state[2] ),
    .B(\cell_state[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_211_));
 sky130_fd_sc_hd__xnor2_2 _585_ (.A(\cell_state[4] ),
    .B(_211_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_061_));
 sky130_fd_sc_hd__nor2_2 _586_ (.A(\cell_state[2] ),
    .B(\cell_state[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_212_));
 sky130_fd_sc_hd__xnor2_2 _587_ (.A(\cell_state[3] ),
    .B(_212_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_060_));
 sky130_fd_sc_hd__nor2_2 _588_ (.A(\cell_state[0] ),
    .B(\cell_state[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_213_));
 sky130_fd_sc_hd__xnor2_2 _589_ (.A(\cell_state[2] ),
    .B(_213_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_059_));
 sky130_fd_sc_hd__nor2_2 _590_ (.A(\cell_state[14] ),
    .B(\cell_state[15] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_214_));
 sky130_fd_sc_hd__xnor2_2 _591_ (.A(\cell_state[0] ),
    .B(_214_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_074_));
 sky130_fd_sc_hd__nor2_2 _592_ (.A(\cell_state[0] ),
    .B(\cell_state[15] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_215_));
 sky130_fd_sc_hd__xnor2_2 _593_ (.A(\cell_state[1] ),
    .B(_215_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_073_));
 sky130_fd_sc_hd__xnor2_2 _594_ (.A(\i_music.sample[6] ),
    .B(\i_music.sample[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_216_));
 sky130_fd_sc_hd__o21a_2 _595_ (.A1(net24),
    .A2(_216_),
    .B1(net22),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_217_));
 sky130_fd_sc_hd__xnor2_2 _596_ (.A(\i_music.sample[3] ),
    .B(\i_music.sample[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_218_));
 sky130_fd_sc_hd__xnor2_2 _597_ (.A(\i_music.sample[1] ),
    .B(\i_music.sample[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_219_));
 sky130_fd_sc_hd__and2_2 _598_ (.A(\i_music.sample[0] ),
    .B(\i_music.sample[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_220_));
 sky130_fd_sc_hd__nor2_2 _599_ (.A(\i_music.sample[0] ),
    .B(\i_music.sample[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_221_));
 sky130_fd_sc_hd__o32a_2 _600_ (.A1(net47),
    .A2(_220_),
    .A3(_221_),
    .B1(_219_),
    .B2(net34),
    ...
    .VPWR(VPWR),
    .X(_222_));
 sky130_fd_sc_hd__xnor2_2 _601_ (.A(\i_music.sample[2] ),
    .B(\i_music.sample[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_223_));
 sky130_fd_sc_hd__a221o_2 _602_ (.A1(net34),
    .A2(_219_),
    .B1(_223_),
    .B2(net33),
    .C1(_222_),
    ...
    .VPWR(VPWR),
    .X(_224_));
 sky130_fd_sc_hd__or2_2 _603_ (.A(net33),
    .B(_223_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_225_));
 sky130_fd_sc_hd__a22o_2 _604_ (.A1(\timing.count[3] ),
    .A2(_218_),
    .B1(_224_),
    .B2(_225_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_226_));
 sky130_fd_sc_hd__xnor2_2 _605_ (.A(\i_music.sample[4] ),
    .B(\i_music.sample[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_227_));
 sky130_fd_sc_hd__o221a_2 _606_ (.A1(\timing.count[3] ),
    .A2(_218_),
    .B1(_227_),
    .B2(net30),
    .C1(_226_),
    ...
    .VPWR(VPWR),
    .X(_228_));
 sky130_fd_sc_hd__xnor2_2 _607_ (.A(\i_music.sample[5] ),
    .B(\i_music.sample[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_229_));
 sky130_fd_sc_hd__a221o_2 _608_ (.A1(net30),
    .A2(_227_),
    .B1(_229_),
    .B2(net28),
    .C1(_228_),
    ...
    .VPWR(VPWR),
    .X(_230_));
 sky130_fd_sc_hd__a21o_2 _609_ (.A1(net24),
    .A2(_216_),
    .B1(net23),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_231_));
 sky130_fd_sc_hd__o211a_2 _610_ (.A1(net28),
    .A2(_229_),
    .B1(_230_),
    .C1(_231_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_232_));
 sky130_fd_sc_hd__nor2_2 _611_ (.A(_217_),
    .B(_232_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(\i_music.pwm ));
 sky130_fd_sc_hd__o211ai_2 _612_ (.A1(_144_),
    .A2(net13),
    .B1(_136_),
    .C1(_142_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_233_));
 sky130_fd_sc_hd__nand2_2 _613_ (.A(net14),
    .B(_136_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_234_));
 sky130_fd_sc_hd__a31o_2 _614_ (.A1(_142_),
    .A2(_144_),
    .A3(net13),
    .B1(_136_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_235_));
 sky130_fd_sc_hd__nand2_2 _615_ (.A(net14),
    .B(_235_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_236_));
 sky130_fd_sc_hd__and3_2 _616_ (.A(net14),
    .B(_233_),
    .C(_235_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_237_));
 sky130_fd_sc_hd__nand2_2 _617_ (.A(_143_),
    .B(_146_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_238_));
 sky130_fd_sc_hd__or3_2 _618_ (.A(_137_),
    .B(_142_),
    .C(net13),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_239_));
 sky130_fd_sc_hd__and2_2 _619_ (.A(_237_),
    .B(_239_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_240_));
 sky130_fd_sc_hd__a41o_2 _620_ (.A1(net14),
    .A2(_233_),
    .A3(_235_),
    .A4(_239_),
    .B1(_076_),
    ...
    .VPWR(VPWR),
    .X(_241_));
 sky130_fd_sc_hd__nand2_2 _621_ (.A(net49),
    .B(_241_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_242_));
 sky130_fd_sc_hd__a21oi_2 _622_ (.A1(_076_),
    .A2(_240_),
    .B1(_242_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_021_));
 sky130_fd_sc_hd__a31o_2 _623_ (.A1(net15),
    .A2(_144_),
    .A3(net13),
    .B1(_143_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_243_));
 sky130_fd_sc_hd__nand2_2 _624_ (.A(_234_),
    .B(_243_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_244_));
 sky130_fd_sc_hd__and3_2 _625_ (.A(\i_music.thresh[1] ),
    .B(_234_),
    .C(_243_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_245_));
 sky130_fd_sc_hd__a21oi_2 _626_ (.A1(_234_),
    .A2(_243_),
    .B1(\i_music.thresh[1] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_246_));
 sky130_fd_sc_hd__or2_2 _627_ (.A(_245_),
    .B(_246_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_247_));
 sky130_fd_sc_hd__a21oi_2 _628_ (.A1(_241_),
    .A2(_247_),
    .B1(_084_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_248_));
 sky130_fd_sc_hd__o21a_2 _629_ (.A1(_241_),
    .A2(_247_),
    .B1(_248_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_022_));
 sky130_fd_sc_hd__nor2_2 _630_ (.A(_142_),
    .B(_146_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_249_));
 sky130_fd_sc_hd__inv_2 _631_ (.A(_249_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_250_));
 sky130_fd_sc_hd__o21ai_2 _632_ (.A1(_244_),
    .A2(_249_),
    .B1(\i_music.thresh[2] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_251_));
 sky130_fd_sc_hd__or3_2 _633_ (.A(\i_music.thresh[2] ),
    .B(_244_),
    .C(_249_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_252_));
 sky130_fd_sc_hd__o21bai_2 _634_ (.A1(_241_),
    .A2(_246_),
    .B1_N(_245_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_253_));
 sky130_fd_sc_hd__a21oi_2 _635_ (.A1(_251_),
    .A2(_252_),
    .B1(_253_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_254_));
 sky130_fd_sc_hd__a31o_2 _636_ (.A1(_251_),
    .A2(_252_),
    .A3(_253_),
    .B1(_084_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_255_));
 sky130_fd_sc_hd__nor2_2 _637_ (.A(_254_),
    .B(_255_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_023_));
 sky130_fd_sc_hd__or2_2 _638_ (.A(_237_),
    .B(_249_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_256_));
 sky130_fd_sc_hd__or2_2 _639_ (.A(_077_),
    .B(_256_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_257_));
 sky130_fd_sc_hd__xnor2_2 _640_ (.A(_077_),
    .B(_256_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_258_));
 sky130_fd_sc_hd__a21boi_2 _641_ (.A1(_252_),
    .A2(_253_),
    .B1_N(_251_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_259_));
 sky130_fd_sc_hd__nand2_2 _642_ (.A(_258_),
    .B(_259_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_260_));
 sky130_fd_sc_hd__or2_2 _643_ (.A(_258_),
    .B(_259_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_261_));
 sky130_fd_sc_hd__and3_2 _644_ (.A(net50),
    .B(_260_),
    .C(_261_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_024_));
 sky130_fd_sc_hd__nand2_2 _645_ (.A(_234_),
    .B(_238_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_262_));
 sky130_fd_sc_hd__and3_2 _646_ (.A(\i_music.thresh[4] ),
    .B(_233_),
    .C(_262_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_263_));
 sky130_fd_sc_hd__a21oi_2 _647_ (.A1(_233_),
    .A2(_262_),
    .B1(\i_music.thresh[4] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_264_));
 sky130_fd_sc_hd__or2_2 _648_ (.A(_263_),
    .B(_264_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_265_));
 sky130_fd_sc_hd__and3_2 _649_ (.A(_257_),
    .B(_261_),
    .C(_265_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_266_));
 sky130_fd_sc_hd__a21oi_2 _650_ (.A1(_257_),
    .A2(_261_),
    .B1(_265_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_267_));
 sky130_fd_sc_hd__nor3_2 _651_ (.A(_084_),
    .B(_266_),
    .C(_267_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_025_));
 sky130_fd_sc_hd__o21ai_2 _652_ (.A1(_240_),
    .A2(_249_),
    .B1(\i_music.thresh[5] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_268_));
 sky130_fd_sc_hd__inv_2 _653_ (.A(_268_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_269_));
 sky130_fd_sc_hd__or3_2 _654_ (.A(\i_music.thresh[5] ),
    .B(_240_),
    .C(_249_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_270_));
 sky130_fd_sc_hd__and2_2 _655_ (.A(_268_),
    .B(_270_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_271_));
 sky130_fd_sc_hd__o21ai_2 _656_ (.A1(_263_),
    .A2(_267_),
    .B1(_271_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_272_));
 sky130_fd_sc_hd__o31a_2 _657_ (.A1(_263_),
    .A2(_267_),
    .A3(_271_),
    .B1(net50),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_273_));
 sky130_fd_sc_hd__and2_2 _658_ (.A(_272_),
    .B(_273_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_026_));
 sky130_fd_sc_hd__a32o_2 _659_ (.A1(net15),
    .A2(_136_),
    .A3(_238_),
    .B1(_250_),
    .B2(_236_),
    ...
    .VPWR(VPWR),
    .X(_274_));
 sky130_fd_sc_hd__nor2_2 _660_ (.A(_078_),
    .B(_274_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_275_));
 sky130_fd_sc_hd__and2_2 _661_ (.A(_078_),
    .B(_274_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_276_));
 sky130_fd_sc_hd__or2_2 _662_ (.A(_275_),
    .B(_276_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_277_));
 sky130_fd_sc_hd__inv_2 _663_ (.A(_277_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_278_));
 sky130_fd_sc_hd__o31a_2 _664_ (.A1(_263_),
    .A2(_267_),
    .A3(_269_),
    .B1(_270_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_279_));
 sky130_fd_sc_hd__or2_2 _665_ (.A(_278_),
    .B(_279_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_280_));
 sky130_fd_sc_hd__o311a_2 _666_ (.A1(_263_),
    .A2(_267_),
    .A3(_269_),
    .B1(_270_),
    .C1(_278_),
    ...
    .VPWR(VPWR),
    .X(_281_));
 sky130_fd_sc_hd__and3b_2 _667_ (.A_N(_281_),
    .B(net50),
    .C(_280_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_027_));
 sky130_fd_sc_hd__or2_2 _668_ (.A(\i_music.thresh[7] ),
    .B(_237_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_282_));
 sky130_fd_sc_hd__inv_2 _669_ (.A(_282_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_283_));
 sky130_fd_sc_hd__and2_2 _670_ (.A(\i_music.thresh[7] ),
    .B(_237_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_284_));
 sky130_fd_sc_hd__nor2_2 _671_ (.A(_283_),
    .B(_284_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_285_));
 sky130_fd_sc_hd__nor2_2 _672_ (.A(_275_),
    .B(_281_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_286_));
 sky130_fd_sc_hd__o31a_2 _673_ (.A1(_275_),
    .A2(_281_),
    .A3(_285_),
    .B1(net50),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_287_));
 sky130_fd_sc_hd__o31a_2 _674_ (.A1(_283_),
    .A2(_284_),
    .A3(_286_),
    .B1(_287_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_028_));
 sky130_fd_sc_hd__a2bb2o_2 _675_ (.A1_N(_075_),
    .A2_N(_233_),
    .B1(_236_),
    .B2(_238_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_288_));
 sky130_fd_sc_hd__nand2_2 _676_ (.A(\i_music.thresh[8] ),
    .B(_288_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_289_));
 sky130_fd_sc_hd__or2_2 _677_ (.A(\i_music.thresh[8] ),
    .B(_288_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_290_));
 sky130_fd_sc_hd__and2_2 _678_ (.A(_289_),
    .B(_290_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_291_));
 sky130_fd_sc_hd__o31a_2 _679_ (.A1(_275_),
    .A2(_281_),
    .A3(_284_),
    .B1(_282_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_292_));
 sky130_fd_sc_hd__or2_2 _680_ (.A(_291_),
    .B(_292_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_293_));
 sky130_fd_sc_hd__o311ai_2 _681_ (.A1(_275_),
    .A2(_281_),
    .A3(_284_),
    .B1(_291_),
    .C1(_282_),
    ...
    .VPWR(VPWR),
    .Y(_294_));
 sky130_fd_sc_hd__and3_2 _682_ (.A(net50),
    .B(_293_),
    .C(_294_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_029_));
 sky130_fd_sc_hd__and3_2 _683_ (.A(_143_),
    .B(_146_),
    .C(_234_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_295_));
 sky130_fd_sc_hd__xnor2_2 _684_ (.A(\i_music.thresh[9] ),
    .B(_295_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_296_));
 sky130_fd_sc_hd__a21oi_2 _685_ (.A1(_289_),
    .A2(_294_),
    .B1(_296_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_297_));
 sky130_fd_sc_hd__a31o_2 _686_ (.A1(_289_),
    .A2(_294_),
    .A3(_296_),
    .B1(_084_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_298_));
 sky130_fd_sc_hd__nor2_2 _687_ (.A(_297_),
    .B(_298_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_030_));
 sky130_fd_sc_hd__a21o_2 _688_ (.A1(net51),
    .A2(hsync),
    .B1(_182_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_299_));
 sky130_fd_sc_hd__and2_2 _689_ (.A(\lfsr_buf[1] ),
    .B(net3),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_031_));
 sky130_fd_sc_hd__xnor2_2 _690_ (.A(_158_),
    .B(_160_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_300_));
 sky130_fd_sc_hd__a211o_2 _691_ (.A1(_165_),
    .A2(_174_),
    .B1(_300_),
    .C1(_162_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_301_));
 sky130_fd_sc_hd__and2_2 _692_ (.A(net22),
    .B(net27),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_302_));
 sky130_fd_sc_hd__nand2_2 _693_ (.A(_168_),
    .B(_179_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_303_));
 sky130_fd_sc_hd__and4_2 _694_ (.A(net18),
    .B(_082_),
    .C(_302_),
    .D(_303_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_304_));
 sky130_fd_sc_hd__o21ai_2 _695_ (.A1(_168_),
    .A2(_179_),
    .B1(_304_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_305_));
 sky130_fd_sc_hd__or2_2 _696_ (.A(_169_),
    .B(_170_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_306_));
 sky130_fd_sc_hd__a221oi_2 _697_ (.A1(_175_),
    .A2(_301_),
    .B1(_306_),
    .B2(_171_),
    .C1(_305_),
    ...
    .VPWR(VPWR),
    .Y(_307_));
 sky130_fd_sc_hd__nand2_2 _698_ (.A(net12),
    .B(net5),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_308_));
 sky130_fd_sc_hd__o311a_2 _699_ (.A1(_086_),
    .A2(_087_),
    .A3(_308_),
    .B1(_307_),
    .C1(_178_),
    ...
    .VPWR(VPWR),
    .X(_309_));
 sky130_fd_sc_hd__a21oi_2 _700_ (.A1(\counter_r[5] ),
    .A2(_144_),
    .B1(net15),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_310_));
 sky130_fd_sc_hd__o21a_2 _701_ (.A1(\counter_r[5] ),
    .A2(_166_),
    .B1(_310_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_311_));
 sky130_fd_sc_hd__and2_2 _702_ (.A(net45),
    .B(_116_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_312_));
 sky130_fd_sc_hd__or2_2 _703_ (.A(net45),
    .B(_116_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_313_));
 sky130_fd_sc_hd__or3_2 _704_ (.A(_111_),
    .B(_112_),
    .C(_118_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_314_));
 sky130_fd_sc_hd__o32a_2 _705_ (.A1(_110_),
    .A2(_129_),
    .A3(_314_),
    .B1(_311_),
    .B2(net42),
    ...
    .VPWR(VPWR),
    .X(_315_));
 sky130_fd_sc_hd__a311o_2 _706_ (.A1(_109_),
    .A2(_113_),
    .A3(_114_),
    .B1(_312_),
    .C1(_111_),
    ...
    .VPWR(VPWR),
    .X(_316_));
 sky130_fd_sc_hd__a211o_2 _707_ (.A1(\counter_r[5] ),
    .A2(_144_),
    .B1(net13),
    .C1(net17),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_317_));
 sky130_fd_sc_hd__o21ai_2 _708_ (.A1(_164_),
    .A2(_310_),
    .B1(_317_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_318_));
 sky130_fd_sc_hd__a22o_2 _709_ (.A1(net42),
    .A2(_311_),
    .B1(_318_),
    .B2(net40),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_319_));
 sky130_fd_sc_hd__a31o_2 _710_ (.A1(_313_),
    .A2(_315_),
    .A3(_316_),
    .B1(_319_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_320_));
 sky130_fd_sc_hd__or3_2 _711_ (.A(net17),
    .B(_142_),
    .C(_317_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_321_));
 sky130_fd_sc_hd__nand2b_2 _712_ (.A_N(_159_),
    .B(_317_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_322_));
 sky130_fd_sc_hd__nand2_2 _713_ (.A(_321_),
    .B(_322_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_323_));
 sky130_fd_sc_hd__o22a_2 _714_ (.A1(\timing.count[17] ),
    .A2(_318_),
    .B1(_323_),
    .B2(net39),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_324_));
 sky130_fd_sc_hd__mux2_1 _715_ (.A0(_137_),
    .A1(_138_),
    .S(_321_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_325_));
 sky130_fd_sc_hd__a22o_2 _716_ (.A1(net39),
    .A2(_323_),
    .B1(_325_),
    .B2(net36),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_326_));
 sky130_fd_sc_hd__a21o_2 _717_ (.A1(_320_),
    .A2(_324_),
    .B1(_326_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_327_));
 sky130_fd_sc_hd__nor3_2 _718_ (.A(net19),
    .B(_082_),
    .C(_124_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_328_));
 sky130_fd_sc_hd__and3_2 _719_ (.A(net19),
    .B(_082_),
    .C(_124_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_329_));
 sky130_fd_sc_hd__o22a_2 _720_ (.A1(net36),
    .A2(_325_),
    .B1(_328_),
    .B2(_329_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_330_));
 sky130_fd_sc_hd__nand2_2 _721_ (.A(_327_),
    .B(_330_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_331_));
 sky130_fd_sc_hd__a22o_2 _722_ (.A1(\cell_state[2] ),
    .A2(_126_),
    .B1(_302_),
    .B2(\cell_state[10] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_332_));
 sky130_fd_sc_hd__a221o_2 _723_ (.A1(\cell_state[14] ),
    .A2(_123_),
    .B1(_127_),
    .B2(\cell_state[6] ),
    .C1(_332_),
    ...
    .VPWR(VPWR),
    .X(_333_));
 sky130_fd_sc_hd__and3_2 _724_ (.A(net23),
    .B(net27),
    .C(\cell_state[11] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_334_));
 sky130_fd_sc_hd__a221o_2 _725_ (.A1(\cell_state[15] ),
    .A2(_123_),
    .B1(_126_),
    .B2(\cell_state[3] ),
    .C1(_334_),
    ...
    .VPWR(VPWR),
    .X(_335_));
 sky130_fd_sc_hd__a211o_2 _726_ (.A1(\cell_state[7] ),
    .A2(_127_),
    .B1(_335_),
    .C1(_083_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_336_));
 sky130_fd_sc_hd__o21ai_2 _727_ (.A1(net29),
    .A2(_333_),
    .B1(_336_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_337_));
 sky130_fd_sc_hd__a221o_2 _728_ (.A1(\cell_state[0] ),
    .A2(_123_),
    .B1(_302_),
    .B2(\cell_state[12] ),
    .C1(net29),
    ...
    .VPWR(VPWR),
    .X(_338_));
 sky130_fd_sc_hd__a221o_2 _729_ (.A1(\cell_state[4] ),
    .A2(_126_),
    .B1(_127_),
    .B2(\cell_state[8] ),
    .C1(_338_),
    ...
    .VPWR(VPWR),
    .X(_339_));
 sky130_fd_sc_hd__and3_2 _730_ (.A(_080_),
    .B(net25),
    .C(\cell_state[5] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_340_));
 sky130_fd_sc_hd__a221o_2 _731_ (.A1(\cell_state[9] ),
    .A2(_127_),
    .B1(_302_),
    .B2(\cell_state[13] ),
    .C1(_083_),
    ...
    .VPWR(VPWR),
    .X(_341_));
 sky130_fd_sc_hd__a211o_2 _732_ (.A1(\cell_state[1] ),
    .A2(_123_),
    .B1(_340_),
    .C1(_341_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_342_));
 sky130_fd_sc_hd__nand2_2 _733_ (.A(_339_),
    .B(_342_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_343_));
 sky130_fd_sc_hd__mux2_1 _734_ (.A0(_337_),
    .A1(_343_),
    .S(net28),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_344_));
 sky130_fd_sc_hd__and3_2 _735_ (.A(_327_),
    .B(_330_),
    .C(_344_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_345_));
 sky130_fd_sc_hd__a21oi_2 _736_ (.A1(_085_),
    .A2(_331_),
    .B1(_345_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_346_));
 sky130_fd_sc_hd__nor2_2 _737_ (.A(was_cell),
    .B(was_tt_sq),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_347_));
 sky130_fd_sc_hd__a211o_2 _738_ (.A1(was_tt_sq),
    .A2(_345_),
    .B1(_347_),
    .C1(_331_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_348_));
 sky130_fd_sc_hd__xnor2_2 _739_ (.A(\lfsr[10] ),
    .B(_142_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_349_));
 sky130_fd_sc_hd__xor2_2 _740_ (.A(\counter_r[3] ),
    .B(\lfsr[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_350_));
 sky130_fd_sc_hd__nand2_2 _741_ (.A(\counter_r[2] ),
    .B(\lfsr[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_351_));
 sky130_fd_sc_hd__or2_2 _742_ (.A(\counter_r[2] ),
    .B(\lfsr[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_352_));
 sky130_fd_sc_hd__xor2_2 _743_ (.A(\counter_r[5] ),
    .B(\lfsr[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_353_));
 sky130_fd_sc_hd__xor2_2 _744_ (.A(\counter_r[4] ),
    .B(\lfsr[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_354_));
 sky130_fd_sc_hd__a221oi_2 _745_ (.A1(\lfsr[8] ),
    .A2(_144_),
    .B1(net13),
    .B2(\lfsr[9] ),
    .C1(_349_),
    ...
    .VPWR(VPWR),
    .Y(_355_));
 sky130_fd_sc_hd__o221a_2 _746_ (.A1(\lfsr[8] ),
    .A2(_144_),
    .B1(_145_),
    .B2(\lfsr[9] ),
    .C1(_355_),
    ...
    .VPWR(VPWR),
    .X(_356_));
 sky130_fd_sc_hd__and4_2 _747_ (.A(_351_),
    .B(_352_),
    .C(_354_),
    .D(_356_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_357_));
 sky130_fd_sc_hd__or4_2 _748_ (.A(\lfsr[12] ),
    .B(\lfsr[11] ),
    .C(\lfsr[14] ),
    .D(\lfsr[15] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_358_));
 sky130_fd_sc_hd__or4_2 _749_ (.A(\lfsr[18] ),
    .B(\lfsr[17] ),
    .C(\lfsr[19] ),
    .D(_358_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_359_));
 sky130_fd_sc_hd__a311o_2 _750_ (.A1(_350_),
    .A2(_353_),
    .A3(_357_),
    .B1(_359_),
    .C1(\lfsr[13] ),
    ...
    .VPWR(VPWR),
    .X(_360_));
 sky130_fd_sc_hd__or3b_2 _751_ (.A(\lfsr[16] ),
    .B(_360_),
    .C_N(_331_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_361_));
 sky130_fd_sc_hd__a21oi_2 _752_ (.A1(_348_),
    .A2(_361_),
    .B1(_309_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_362_));
 sky130_fd_sc_hd__nor3_2 _753_ (.A(\lfsr[3] ),
    .B(\lfsr[2] ),
    .C(\lfsr[1] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_363_));
 sky130_fd_sc_hd__and3_2 _754_ (.A(\lfsr[0] ),
    .B(_348_),
    .C(_363_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_364_));
 sky130_fd_sc_hd__a211oi_2 _755_ (.A1(_348_),
    .A2(_361_),
    .B1(_364_),
    .C1(_309_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_365_));
 sky130_fd_sc_hd__o21ai_2 _756_ (.A1(net12),
    .A2(net5),
    .B1(net10),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_366_));
 sky130_fd_sc_hd__or2_2 _757_ (.A(net7),
    .B(net5),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_367_));
 sky130_fd_sc_hd__a32o_2 _758_ (.A1(_308_),
    .A2(_366_),
    .A3(_367_),
    .B1(_087_),
    .B2(net12),
    ...
    .VPWR(VPWR),
    .X(_368_));
 sky130_fd_sc_hd__and2_2 _759_ (.A(_309_),
    .B(_368_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_369_));
 sky130_fd_sc_hd__o31a_2 _760_ (.A1(_143_),
    .A2(_146_),
    .A3(_234_),
    .B1(\timing.active ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_370_));
 sky130_fd_sc_hd__o21a_2 _761_ (.A1(_365_),
    .A2(_369_),
    .B1(_370_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_032_));
 sky130_fd_sc_hd__nor2_2 _762_ (.A(_361_),
    .B(_363_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_371_));
 sky130_fd_sc_hd__a21bo_2 _763_ (.A1(net7),
    .A2(_308_),
    .B1_N(_366_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_372_));
 sky130_fd_sc_hd__o211ai_2 _764_ (.A1(_087_),
    .A2(_366_),
    .B1(_372_),
    .C1(_309_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_373_));
 sky130_fd_sc_hd__o311a_2 _765_ (.A1(_309_),
    .A2(_345_),
    .A3(_371_),
    .B1(_373_),
    .C1(_370_),
    ...
    .VPWR(VPWR),
    .X(_033_));
 sky130_fd_sc_hd__nor2_2 _766_ (.A(net9),
    .B(_088_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_374_));
 sky130_fd_sc_hd__a22o_2 _767_ (.A1(_086_),
    .A2(net11),
    .B1(net7),
    .B2(_088_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_375_));
 sky130_fd_sc_hd__o21a_2 _768_ (.A1(net10),
    .A2(net11),
    .B1(_088_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_376_));
 sky130_fd_sc_hd__nand2_2 _769_ (.A(net9),
    .B(_376_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_377_));
 sky130_fd_sc_hd__o211a_2 _770_ (.A1(_374_),
    .A2(_375_),
    .B1(_377_),
    .C1(_309_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_378_));
 sky130_fd_sc_hd__o21a_2 _771_ (.A1(_362_),
    .A2(_378_),
    .B1(_370_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_034_));
 sky130_fd_sc_hd__nor3_2 _772_ (.A(\lfsr[3] ),
    .B(\lfsr[2] ),
    .C(\lfsr[0] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_379_));
 sky130_fd_sc_hd__nor2_2 _773_ (.A(_361_),
    .B(_379_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_380_));
 sky130_fd_sc_hd__or3_2 _774_ (.A(_309_),
    .B(_345_),
    .C(_380_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_381_));
 sky130_fd_sc_hd__a21oi_2 _775_ (.A1(net10),
    .A2(net11),
    .B1(net7),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_382_));
 sky130_fd_sc_hd__or3b_2 _776_ (.A(_376_),
    .B(_382_),
    .C_N(_309_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_383_));
 sky130_fd_sc_hd__and3_2 _777_ (.A(_370_),
    .B(_381_),
    .C(_383_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_035_));
 sky130_fd_sc_hd__nor2_2 _778_ (.A(net11),
    .B(net8),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_384_));
 sky130_fd_sc_hd__mux2_1 _779_ (.A0(net8),
    .A1(_384_),
    .S(\rom_q[1] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_385_));
 sky130_fd_sc_hd__mux2_1 _780_ (.A0(net6),
    .A1(_376_),
    .S(_385_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_386_));
 sky130_fd_sc_hd__inv_2 _781_ (.A(_386_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_387_));
 sky130_fd_sc_hd__and2_2 _782_ (.A(_309_),
    .B(_387_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_388_));
 sky130_fd_sc_hd__o21a_2 _783_ (.A1(_362_),
    .A2(_388_),
    .B1(_370_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_036_));
 sky130_fd_sc_hd__nor2_2 _784_ (.A(\lfsr[1] ),
    .B(_361_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_389_));
 sky130_fd_sc_hd__o21ba_2 _785_ (.A1(\rom_q[0] ),
    .A2(net6),
    .B1_N(_374_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_390_));
 sky130_fd_sc_hd__and2_2 _786_ (.A(_086_),
    .B(_390_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_391_));
 sky130_fd_sc_hd__nor2_2 _787_ (.A(_086_),
    .B(_390_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_392_));
 sky130_fd_sc_hd__or4b_2 _788_ (.A(_384_),
    .B(_391_),
    .C(_392_),
    .D_N(_309_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_393_));
 sky130_fd_sc_hd__o211a_2 _789_ (.A1(_381_),
    .A2(_389_),
    .B1(_393_),
    .C1(_370_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_037_));
 sky130_fd_sc_hd__and2b_2 _790_ (.A_N(net47),
    .B(was_tt_sq),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_394_));
 sky130_fd_sc_hd__a31o_2 _791_ (.A1(net48),
    .A2(_178_),
    .A3(_307_),
    .B1(_394_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__buf_2 _914_ (.A(hsync_r),
    ...
    .VPWR(VPWR),
    .X(uo_out[7]));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout1 (.A(net2),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net1));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout10 (.A(\rom_q[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout11 (.A(net12),
    ...
    .VPWR(VPWR),
    .X(net11));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout12 (.A(\rom_q[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net12));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout13 (.A(_145_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout16 (.A(net17),
    ...
    .VPWR(VPWR),
    .X(net16));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout17 (.A(\counter_r[10] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout19 (.A(net20),
    ...
    .VPWR(VPWR),
    .X(net19));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout2 (.A(cell_rst_n),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout20 (.A(net21),
    ...
    .VPWR(VPWR),
    .X(net20));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout21 (.A(\timing.count[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout22 (.A(net23),
    ...
    .VPWR(VPWR),
    .X(net22));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout23 (.A(\timing.count[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout26 (.A(net27),
    ...
    .VPWR(VPWR),
    .X(net26));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout27 (.A(\timing.count[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net27));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout28 (.A(\timing.count[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout31 (.A(net32),
    ...
    .VPWR(VPWR),
    .X(net31));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout32 (.A(\timing.count[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net32));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout33 (.A(\timing.count[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net33));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout34 (.A(\timing.count[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout36 (.A(net37),
    ...
    .VPWR(VPWR),
    .X(net36));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout37 (.A(\timing.count[19] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net37));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout38 (.A(\timing.count[18] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net38));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout39 (.A(\timing.count[18] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net39));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout4 (.A(_299_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net4));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout40 (.A(\timing.count[17] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout42 (.A(net43),
    ...
    .VPWR(VPWR),
    .X(net42));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout43 (.A(\timing.count[16] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout45 (.A(net46),
    ...
    .VPWR(VPWR),
    .X(net45));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout46 (.A(\timing.count[15] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net46));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout47 (.A(\timing.count[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net47));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout48 (.A(\timing.count[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout49 (.A(net52),
    ...
    .VPWR(VPWR),
    .X(net49));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout5 (.A(\rom_q[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout51 (.A(net52),
    ...
    .VPWR(VPWR),
    .X(net51));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout52 (.A(rst_n),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout6 (.A(\rom_q[3] ),
    ...
    .VPWR(VPWR),
    .X(net6));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout7 (.A(\rom_q[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 incrementer \timing.counter  (.VPWR(VPWR),
    ...
    \timing.count[1] ,
    \timing.count[0] }));
 sky130_fd_sc_hd__conb_1 \timing.counter_66  (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .HI(net66));
 sky130_fd_sc_hd__and2_1 \timing.i_and  (.A(net49),
    .B(\timing.count_max ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(\timing.count_rst_n ));
 sky130_fd_sc_hd__nand4_1 \timing.i_nand  (.A(net37),
    .B(net43),
    .C(net46),
    .D(\timing.count[14] ),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__conb_1 tt_um_rebelmike_asic_odyssey (.VGND(VGND),
    ...
    .VPWR(VPWR),
    .LO(net));
 sky130_fd_sc_hd__conb_1 tt_um_rebelmike_asic_odyssey_53 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net53));
 sky130_fd_sc_hd__conb_1 tt_um_rebelmike_asic_odyssey_54 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net54));
 sky130_fd_sc_hd__conb_1 tt_um_rebelmike_asic_odyssey_55 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net55));
 sky130_fd_sc_hd__conb_1 tt_um_rebelmike_asic_odyssey_56 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net56));
 sky130_fd_sc_hd__conb_1 tt_um_rebelmike_asic_odyssey_57 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net57));
 sky130_fd_sc_hd__conb_1 tt_um_rebelmike_asic_odyssey_58 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net58));
